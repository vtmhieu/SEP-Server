...
INSERT INTO TASK (event_id, project_reference, description, assignee, subteam, comments, priority, status) VALUES ('2', 'AI Expo', 'Set up the lighting/sound for all the booths at the expo', 'Sarah', 'Music', '', 'CRITICAL', 'CREATED');
...
INSERT INTO FINANCIAL_REQUESTS (requesting_department, project_reference, required_amount, currency, reason, status, fm_notes, created_at, updated_at) VALUES ('PRODUCTION', 'PROJ-001', 5000.00, 'SEK', 'New development laptops for production team', 'PENDING', NULL, '2025-01-15 08:00:00', NULL);

INSERT INTO FINANCIAL_REQUESTS (requesting_department, project_reference, required_amount, currency, reason, status, fm_notes, created_at, updated_at) VALUES ('SERVICES', 'PROJ-002', 2500.00, 'SEK', 'Conference attendance for team members', 'APPROVED', 'Approved based on Q1 budget allocation', '2025-01-16 10:30:00', '2025-01-16 15:10:00');

INSERT INTO FINANCIAL_REQUESTS (requesting_department, project_reference, required_amount, currency, reason, status, fm_notes, created_at, updated_at) VALUES ('PRODUCTION', 'PROJ-003', 10000.00, 'SEK', 'Additional budget for project expansion', 'REJECTED', 'Exceeds budget limits for this quarter', '2025-01-14 14:20:00', '2025-01-17 11:30:00');